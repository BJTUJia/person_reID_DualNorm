...
parser.add_argument('--which_epoch',default='99', type=str, help='0,1,2,3...or last')
parser.add_argument('--test_dir',default='../test/VIPeR',type=str, help='./test_data')
...
dataloaders = {x: torch.utils.data.DataLoader(image_datasets[x], batch_size=opt.batchsize,
                                              shuffle=False, num_workers=4) for x in ['cam_a','cam_b']}
...
model_structure = models.init_model(name='mobilenet', num_classes=17685)
#
...
scipy.io.savemat('../data/VIPeR/pytorch_result_viper_%s.mat'%opt.which_epoch,result)
